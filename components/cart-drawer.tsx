                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <button
                                            ...
                                            className={`relative flex flex-col items-center justify-center p-4 border rounded-xl transition-all ${customerData.isDelivery === true
                                                ...
                                                : 'border-[#EBEBEB] bg-white hover:border-[#000000]/50'
                                                }`}
                                        >
                                            ...
                                            <Truck className={`h-6 w-6 mb-2 ${customerData.isDelivery === true ? 'text-[#000000]' : 'text-[#717171]'}`} />
                                            <span className={`font-medium text-sm ${customerData.isDelivery === true ? 'text-[#000000]' : 'text-[#1A1A1A]'}`}>Delivery</span>
                                        ...
                                        >
                                            ...
                                            <Store className={`h-6 w-6 mb-2 ${customerData.isDelivery === false ? 'text-[#000000]' : 'text-[#717171]'}`} />
                                            <span className={`font-medium text-sm ${customerData.isDelivery === false ? 'text-[#000000]' : 'text-[#1A1A1A]'}`}>Store Pickup</span>
                                            ...
                                            >
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full px-4 py-3 border rounded-lg text-sm focus:outline-none focus:ring-2 transition-all ${errors.name
                                                            ...
                                                            : 'border-[#EBEBEB] focus:ring-[#000000]/20 focus:border-[#000000]'
                                                            }`}
                                                ...
                                                <div className="flex gap-3 pt-2">
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={isSubmitting}
                                                        className="flex-1 py-3 bg-[#000000] text-white font-medium rounded-lg hover:bg-[#000000] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                                                    >
                                                        {isSubmitting ? (
                                                            <>
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-1 bg-white rounded-lg border border-[#EBEBEB]">
                                                        <button
                                                            ...
                                                            className="p-1.5 hover:bg-[#F8F8F8] transition-colors text-[#717171] hover:text-[#000000] rounded-l-lg"
                                                        ...
                                                        <button
                                                            onClick={() => updateQuantity(item.id, item.quantity + 1, item.selectedVariation?.id)}
                                                            className="p-1.5 hover:bg-[#F8F8F8] transition-colors text-[#717171] hover:text-[#000000] rounded-r-lg"
                                                        >
                        ...
                        {!isOrderPlaced && !showCustomerForm && items.length > 0 && (
                            <div className="p-4 border-t border-[#EBEBEB] bg-white space-y-4">
                                        ...
                                        <div className="flex gap-2">
                                            <div className="flex-1">
                                                <input
                                                    ...
                                                    className="w-full px-4 py-2.5 bg-[#F8F8F8] border border-[#EBEBEB] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#000000]/20 focus:border-[#000000] transition-all"
                                                />
                                            </div>
                                            <button
                                ...
                                <button
                                    ...
                                    className="w-full py-3.5 bg-[#000000] text-white font-semibold rounded-lg hover:bg-[#000000] transition-colors flex items-center justify-center gap-2"
                                >
                                    {!user && (
