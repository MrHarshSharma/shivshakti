        ...
        <>
            <nav className="fixed top-0 z-50 w-full border-b border-orange-100/50 bg-[#FEFBF5]/80 backdrop-blur-md transition-all shadow-sm">
                <div className="container mx-auto flex h-24 items-center justify-between px-6">
                    {/* Logo */}
                    <Link href="/" className="relative h-16 w-[65px] rounded-full overflow-hidden transition-opacity hover:opacity-80 shadow-sm border border-orange-50">
                        <Image
                            src="/image.png"
                            alt="Shivshakti Logo"
                            fill
                    ...
                    <div className="flex items-center gap-3 md:gap-4">
                        ...
                        {user ? (
                            ...
                            <button
                                ...
                                className="hidden sm:flex items-center gap-2 px-5 py-2.5 bg-white border border-orange-200 text-[#2D1B1B] rounded-full text-[10px] font-black hover:bg-orange-50 transition-all shadow-sm hover:shadow-md uppercase tracking-[0.15em]"
                            >
                                Sign In
                            </button>
                        )}
                            ...
                            <div className="w-full max-w-sm">
                                ...
                                {!user && (
                                    <motion.div
                                        ...
                                        className="w-full mt-16 pt-12 border-t border-orange-100"
                                    >
                                        <button
                                            onClick={() => { loginWithGoogle(); setIsMenuOpen(false); }}
                                            className="w-full py-5 bg-[#2D1B1B] text-white rounded-2xl font-black uppercase tracking-[0.25em] text-xs shadow-2xl active:bg-saffron transition-all duration-300 border border-orange-50/10"
                                        >
                                            Sign In with Google
                                        </button>
                                    </motion.div>
